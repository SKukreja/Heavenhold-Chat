...
namespace Interactivity
{
    ...
    public class PageBuilder
    {
        ...
        public PageBuilder WithFooter(EmbedFooterBuilder footer)
        {
            ...
            {
                Text = "Powered by Heavenhold.com",
                IconUrl = System.Configuration.ConfigurationManager.AppSettings["copyRightIconUrl"]
            };
            return this;
        }
        ...
        internal PageBuilder WithPaginatorFooter(PaginatorFooter footer, int page, int totalPages, IList<SocketUser> users)
        {
            ...
            if (footer.HasFlag(PaginatorFooter.Users))
            {
                ...
                if (users.Count == 1)
                {
                    ...
                    Footer.IconUrl = System.Configuration.ConfigurationManager.AppSettings["copyRightIconUrl"];
                    Footer.Text = "Powered by Heavenhold.com";
                }
                else
                {
